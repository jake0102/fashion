                                ...
                                if(item.id == contents.item[i]){
                                    return(
                                        <div key={index} className="Cart-body-item">
                                            ...
                                            <div className="Cart-body-item-inf">
                                                <div className="Cart-body-item-inf-item">Price: {item.des}</div>
                                                <div className="Cart-body-item-inf-item">Rating: {item.rating} / 5 rating</div>
